...
contract Game {
    ...
    function pickACard() private view returns (uint256) {
        //'abi.encodePacked(arg); takes in the two params - blockhash and block.timestamp
        // and returns a byte array which further gets passed into keccak256 which returns bytes 32
    ...
    If the player guessed the correct number, it sends the player 0.1 eth
     */
